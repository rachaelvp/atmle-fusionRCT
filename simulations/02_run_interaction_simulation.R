...
result_list <- list()
for (i in 1:B) {
  load(paste0("~/atmle-fusionRCT/simulations/output/ASinter_res",i,".Rdata"))
...
write.csv(res, file = "~/atmle-fusionRCT/simulations/results_ASinteraction.csv", row.names = F)
